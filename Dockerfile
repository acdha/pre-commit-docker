...
RUN curl --silent --fail https://releases.hashicorp.com/terraform/1.0.9/terraform_1.0.9_linux_amd64.zip | busybox unzip -d /usr/bin/ /dev/stdin && chmod a+x /usr/bin/terraform
